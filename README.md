...
![Perception Framework Figure](框架图-.jpg)
...
|---|---:|---:|---:|---:|---|
| `timestamp_ms` error (ms) | `25.04` | `26.5 / 26` | `37` | `46` | Time delta between the video frame and the nearest radar frame |
| `vehicles[].center` error (m) | `2.5132` | `1.6251 / 1.6251` | `3.1987` | `6.7021` | Spatial position error of matched targets |
| `vehicles[].speed_scalar` error (m/s) | `1.6727` | `0.3176 / 0.3176` | `1.7741` | `5.0061` | Speed scalar error of matched targets |
